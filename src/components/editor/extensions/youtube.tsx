...
function TiptapYoutube(props: NodeViewProps) {
  ...
  function resize(event: MouseEvent) {
    ...
    const newWidth = Math.max(resizeInitialWidth + dx, 300); // Minimum width: 300 for video
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Overlay to capture clicks when selected or resizing to prevent iframe interaction */}
        <div
          className={cn(
        ...
        {editor?.isEditable && (
          <>
            ...
            >
              <div className="z-20 h-[70px] w-1 rounded-xl border bg-[rgba(255,255,255,0.65)] opacity-0 transition-all group-hover:opacity-100" />
            </div>
            <div
